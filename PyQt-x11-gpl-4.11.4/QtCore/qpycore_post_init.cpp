...
#if PY_MAJOR_VERSION >= 3
    PyObject *sip_flags = PyUnicode_FromString("-x VendorID -t WS_X11 -t Qt_4_8_6 -x PyQt_qreal_double -x Py_v3");
#else
    PyObject *sip_flags = PyString_FromString("-x VendorID -t WS_X11 -t Qt_4_8_6 -x PyQt_qreal_double -x Py_v3");
#endif
